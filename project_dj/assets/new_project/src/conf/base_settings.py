"""
Foundation for the Django settings

This file is not templated, so it can be updated and deployed through version control

It should not hold thigns like passwords or hard-coded system paths
    - put such things in the normal settings file
...
SECRET_KEY = '*4yc7#p+n-t_@p2=at71unqz(5=m!2(k-%uq^p^4(fb@ri(m05'
...
ROOT_URLCONF = 'PROJECTDJPROJECT.urls'
